...
Free, open-source form builder and survey platform
...
- **ohmyform**: ohmyform/ohmyform:latest

### Infrastructure Components

- **ohmyform-db**: Mongo database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/ohmyform/main/docker-compose.yaml" -o compose.yml
```
...
```shell
docker compose logs -f ohmyform
```
